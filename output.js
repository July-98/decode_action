//Fri Aug 16 2024 16:23:42 GMT+0000 (Coordinated Universal Time)
...
(() => {
  ...
  function d(U, V) {
    if (U) {
      ...
      return "Map" === X || "Set" === X ? Array.from(U) : "Arguments" === X || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(X) ? f(U, V) : void 0;
    }
  }
  function f(U, V) {
